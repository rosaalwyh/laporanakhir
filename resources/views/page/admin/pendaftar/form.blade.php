...
{{-- FORM UBAH PENDAFTAR --}}
<div class="modal fade" id="form_ubah_pendaftar" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="form-ubah-pendaftarTitle">Form Ubah Pendaftar</h5>
                    ...
                    <div class="white_card_body">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" aria-describedby="basic-addon1" name="ubah_nama_lengkap" id="ubah_nama_lengkap" value="{{$pendaftar->nama_lengkap}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" aria-describedby="basic-addon2" name="ubah_nim" id="ubah_nim" value="{{$pendaftar->nim}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" aria-describedby="basic-addon2" name="ubah_asal_kampus" id="ubah_asal_kampus" value="{{$pendaftar->asal_kampus}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" aria-describedby="basic-addon2" name="ubah_jurusan" id="ubah_jurusan" value="{{$pendaftar->jurusan}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="col">
                            <div class="input-group mb-3">
                                <input type="date" class="form-control" aria-describedby="basic-addon2" name="ubah_tanggal_lahir" id="ubah_tanggal_lahir" value="{{$pendaftar->tanggal_lahir}}">
                            </div>
                        </div>
                        </div>
                        <select class="custom-select mb-3" id="bagian_id" name="bagian_id">
...
<div class="modal fade" id="form_tambah_pendaftar" tabindex="-1" role="dialog" aria-labelledby="form-tambah-pendaftarTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="form-tambah-pendaftarTitle">Form Tambah Pendaftar</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
            ...
            <div class="col-lg-12">
                <div class="white_card card_height_100 mb_10">
                    <div class="white_card_body">
                        ...
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" accept=".pdf" class="custom-file-input" id="proposal" aria-describedby="proposal" name="proposal">
                                <label class="custom-file-label" for="proposal" >Pilih file Proposal</label>
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" accept=".pdf" class="custom-file-input" id="ktm" aria-describedby="ktm" name="ktm">
