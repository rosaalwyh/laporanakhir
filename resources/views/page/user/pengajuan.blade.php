...
@section('title', 'Pengajuan Praktik Kerja Lapangan')
@section('content')
        ...
        <div class="col-lg-10">
            <div class="white_card card_height_100 mb_10">
                <div class="white_card_body">
                    <form method="POST" class="mt-5" action="{{route('user.addpendaftar')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="result">
                        ...
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" accept=".pdf" class="custom-file-input" id="proposal" aria-describedby="proposal" name="proposal" required>
                                <label class="custom-file-label" for="proposal">Pilih file Proposal</label>
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" accept=".pdf" class="custom-file-input" id="ktm" aria-describedby="ktm" name="ktm" required>
                                <label class="custom-file-label" for="ktm">Pilih file Kartu Tanda Mahasiswa</label>
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" accept=".pdf" class="custom-file-input" id="surat_pengantar" aria-describedby="surat_pengantar" name="surat_pengantar" required>
                                <label class="custom-file-label" for="surat_pengantar">Pilih Surat Pengantar</label>
                            </div>
                        </div>
                        {{-- <div class="input-group mb-3">
